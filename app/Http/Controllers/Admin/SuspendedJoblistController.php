...
class SuspendedJoblistController extends Controller
{
	...
	{
		$jobspaces = JobSpace::latest()->select('job_spaces.*')->where('job_spaces.status','Suspended')->get();
        
		return view('admin.suspendedjoblists.index',compact('jobspaces'));
	}
