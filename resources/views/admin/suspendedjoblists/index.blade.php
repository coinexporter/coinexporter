...
@section('page_title')
    {{__('suspendedjoblists.index.title')}}
@endsection
        ...
        <div class="page-header">
            <div class="card breadcrumb-card">
                <div class="row justify-content-between align-content-between" style="height: 100%;">
                    <div class="col-md-6">
                        <h3 class="page-title">{{__('suspendedjoblists.index.title')}}</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="{{ route('dashboard') }}">Dashboard</a>
                            </li>
                            <li class="breadcrumb-item active-breadcrumb">
                                <a href="{{ route('suspendedjoblists.index') }}">{{ __('suspendedjoblists.index.title') }}</a>
                            </li>
                        </ul>
                    </div>
                                 ...
                                 @if($jobspaces)
                                        ...
                                        @php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <span class="badge @if($jobspace->status == 'Suspended') bg-warning @endif">{{ucfirst($jobspace->status)}}</span>
