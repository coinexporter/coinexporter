...
@section('page_title')
    {{__('deletedjoblists.index.title')}}
@endsection
        ...
        <div class="page-header">
            <div class="card breadcrumb-card">
                <div class="row justify-content-between align-content-between" style="height: 100%;">
                    <div class="col-md-6">
                        <h3 class="page-title">{{__('deletedjoblists.index.title')}}</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="{{ route('dashboard') }}">Dashboard</a>
                            </li>
                            <li class="breadcrumb-item active-breadcrumb">
                                <a href="{{ route('deletedjoblists.index') }}">{{ __('deletedjoblists.index.title') }}</a>
                            </li>
                        </ul>
                    </div>
                                 ...
                                 @if($jobspaces)
                                        ...
                                        @php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <span class="badge @if($jobspace->status == 'Rejected') bg-danger @elseif($jobspace->status == 'Suspended') bg-warning @elseif($jobspace->status == 'Approved') bg-success @endif">{{ucfirst($jobspace->status)}}</span>
