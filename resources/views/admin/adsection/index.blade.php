        ...
        <div class="row justify-content-between align-content-between" style="height: 100%;">
            ...
            <div class="col-md-3">
                <div class="create-btn pull-right">
                    <a href="{{ route('adsection.create') }}" class="btn custom-create-btn">{{ __('Add New Banner') }}</a>
                </div>
            </div>
            {{-- @endif  --}}
                ...
                <table class="table table-report -mt-2" id="jobspaces_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge @if($val->status == 'left')bg-success @else bg-info @endif">{{ucfirst($val->status)}}</span></td>
                            <td>
                           
                                <span class="flex justify-center items-center">
                                    <button class="custom-delete-btn remove-role" data-id="{{ $val->id }}" data-action="/nupe/ad_section/destroy">
