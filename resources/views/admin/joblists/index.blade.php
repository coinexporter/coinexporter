                                    ...
                                    @if($jobspaces)
                                        ...
                                        @php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <span class="badge @if($jobspace->status == 'Rejected') bg-danger  @elseif($jobspace->status == 'Suspended') bg-warning @else bg-success @endif">{{ucfirst($jobspace->status)}}</span>
									  
                                            
                                                </td>
                                                <td><a href="{{route('jobspaces.logview', $jobspace->id)}}" class="custom-edit-btn mr-1 disabled"><i class="fa fa-eye mr-1"></i></a>
                                                
                                            <a href="{{route('jobspaces.destroy', $jobspace->id)}}" class="custom-edit-btn mr-1 disabled" style="background-color:red;"><i class="fe fe-trash mr-1"></i></a>
                                            </td>
                                            </tr> 
                                            @endif
                                        @endforeach
