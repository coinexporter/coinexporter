...
<div class="header">
    ...
    <ul class="nav user-menu">
        ...
        <!-- Frontend -->
        <li class="nav-item">
            <a href="{{route('dashboard')}}" target="_blank" class="dropdown-toggle nav-link" title="Front End">
        ...
        <li class="nav-item dropdown noti-dropdown">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                <i class="fe fe-bell"></i> <span class="badge badge-pill">{{ $user->unreadNotifications->count() }} </span>
            </a>
                            ...
                            <!-- <a href="#"> -->
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        - $hours*60*60)/ 60);
                                        @endphp
                                        <p class="noti-details"><span class="noti-title">{!! $notification->data['data'] !!}</span></p>
