        ...
        <div class="row justify-content-between align-content-between" style="height: 100%;">
            ...
            <div class="col-md-3">
                <div class="create-btn pull-right">
                    <a href="{{ route('reviews.create') }}" class="btn custom-create-btn">{{ __('Add New Review') }}</a>
                </div>
            </div>
            {{-- @endif  --}}
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="flex justify-center items-center">
                                    <button class="custom-delete-btn remove-role" data-id="{{ $val->id }}" data-action="/nupe/reviews/destroy">
